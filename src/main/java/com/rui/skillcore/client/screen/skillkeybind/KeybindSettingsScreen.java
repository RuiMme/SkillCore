...
public class KeybindSettingsScreen extends Screen {
    ...
    public KeybindSettingsScreen(Screen parentScreen) {
        super(new StringTextComponent("自定义按键管理"));
    ...
    protected void init() {
        ...
        for (int i = 0; i < CustomKeybindRegistry.CATEGORIES.size(); i++) {
            ...
            Button navBtn = this.addButton(new Button(10, btnY, leftPanelWidth - 20, 20, new StringTextComponent(category.name), (btn) -> {
        ...
        if (this.currentCategory != null) {
            ...
            this.children.add(this.rightPanelList);
        }
        ...
        this.addButton(new Button(btn1X, bottomY, btnWidth, 20, new StringTextComponent("恢复当前页默认"), (button) -> {
            if (this.currentCategory != null) {
        ...
        this.addButton(new Button(btn2X, bottomY, btnWidth, 20, new StringTextComponent("完成"), (button) -> {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (this.activeBind != null) {
            if (keyCode == GLFW.GLFW_KEY_ESCAPE) {
                // ESC 键清空绑定
                this.activeBind.setKey(InputMappings.UNKNOWN, false, false, false);
                this.activeBind = null;
                return true;
            }
            ...
            if (!isModifierKey) {
                ...
                this.activeBind.setKey(InputMappings.Type.KEYSYM.getOrCreate(keyCode), ctrl, shift, alt);
                this.activeBind = null;
                return true;
            }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (this.activeBind != null) {
            ...
            this.activeBind.setKey(InputMappings.Type.MOUSE.getOrCreate(button), ctrl, shift, alt);
            this.activeBind = null;
            return true;
        }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.currentCategory != null) {
            ...
            drawCenteredString(matrixStack, this.font, new StringTextComponent(categoryTitle), leftPanelWidth + (this.width - leftPanelWidth) / 2, 15, 0xAAAAAA);
        }
