...
public class SkillPlaceholderManager {
    ...
    private static final Map<String, Function<LocalPlayer, String>> PLACEHOLDERS = new HashMap<>();
     ...
     */
    public static void register(String key, Function<LocalPlayer, String> resolver) {
     ...
     */
    public static String parse(String rawText, LocalPlayer player) {
        if (rawText == null || rawText.isEmpty()) return rawText;

        String parsedText = rawText;
        // 遍历所有已注册的占位符
        for (Map.Entry<String, Function<LocalPlayer, String>> entry : PLACEHOLDERS.entrySet()) {
