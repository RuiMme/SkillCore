...
public class KeyBindings extends KeyBinding {
    ...
    public static final KeyBinding OPEN_SKILL_SCREEN = new KeyBindings("open_skill_screen", KeyConflictContext.IN_GAME, KeyModifier.NONE, GLFW.GLFW_KEY_K, "key.category.skill");
