...
public class PacketHandler {
    ...
    public static void init() {
        ...
        HANDLER.registerMessage(id++, com.rui.skillcore.api.network.json.S2CSyncSkillsPacket.class, com.rui.skillcore.api.network.json.S2CSyncSkillsPacket::encode, com.rui.skillcore.api.network.json.S2CSyncSkillsPacket::new, com.rui.skillcore.api.network.json.S2CSyncSkillsPacket::handle);
    }
